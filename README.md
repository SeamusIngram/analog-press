# analog-press
Alternative Digital-to-Analog (DTA) input for box style controllers which aims to more closely follow traditional analog stick behavior. The code in this repository allows you to visualize your inputs, for both Analog Press and the DTA scheme used in current box-style controllers. To see how Analog Press works, head to [DTA Methodology](#dta-methodology)
